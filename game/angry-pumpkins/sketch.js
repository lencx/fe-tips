// https://x.com/javilopen/status/1719363262179938401
...
function propagateImpact(body, impactMagnitude, impactThreshold, originalCollisionPosition, visitedBodies = new Set()) {
  ...
  for (let result of bodiesInContact) {
    ...
    let reducedImpactMagnitude = impactMagnitude / (1 + distanceFromOriginal / 500); // Ajustar el divisor según sea necesario
